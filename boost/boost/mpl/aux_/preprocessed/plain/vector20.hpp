...
template<>
struct push_back_traits< aux::vector_tag< 10> >
{
...
template<>
struct pop_back_traits< aux::vector_tag< 11> >
{
...
template<>
struct push_back_traits< aux::vector_tag< 11> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector12<
...
template<>
struct pop_back_traits< aux::vector_tag< 12> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector11<
...
template<>
struct push_back_traits< aux::vector_tag< 12> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector13<
...
template<>
struct pop_back_traits< aux::vector_tag< 13> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector12<
...
template<>
struct push_back_traits< aux::vector_tag< 13> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector14<
...
template<>
struct pop_back_traits< aux::vector_tag< 14> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector13<
...
template<>
struct push_back_traits< aux::vector_tag< 14> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector15<
...
template<>
struct pop_back_traits< aux::vector_tag< 15> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector14<
...
template<>
struct push_back_traits< aux::vector_tag< 15> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector16<
...
template<>
struct pop_back_traits< aux::vector_tag< 16> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector15<
...
template<>
struct push_back_traits< aux::vector_tag< 16> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector17<
...
template<>
struct pop_back_traits< aux::vector_tag< 17> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector16<
...
template<>
struct push_back_traits< aux::vector_tag< 17> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector18<
...
template<>
struct pop_back_traits< aux::vector_tag< 18> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector17<
...
template<>
struct push_back_traits< aux::vector_tag< 18> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector19<
...
template<>
struct pop_back_traits< aux::vector_tag< 19> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector18<
...
template<>
struct push_back_traits< aux::vector_tag< 19> >
{
    template< typename Vector, typename T > struct algorithm
    {
        typedef vector20<
...
template<>
struct pop_back_traits< aux::vector_tag< 20> >
{
    template< typename Vector > struct algorithm
    {
        typedef vector19<
