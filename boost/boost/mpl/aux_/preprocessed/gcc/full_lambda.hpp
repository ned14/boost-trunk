...
struct lambda_impl< -1,F<T1,T2,T3> >
...
struct lambda_impl< 3,F<T1,T2,T3> >
...
struct lambda_impl< -1,F<T1,T2,T3,T4> >
...
struct lambda_impl< 4,F<T1,T2,T3,T4> >
...
struct lambda_impl< -1,F<T1,T2,T3,T4,T5> >
...
struct lambda_impl< 5,F<T1,T2,T3,T4,T5> >
