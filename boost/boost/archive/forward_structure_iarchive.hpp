#ifndef BOOST_ARCHIVE_FORWARD_STRUCTURE_IARCHIVE_HPP
#define BOOST_ARCHIVE_FORWARD_STRUCTURE_IARCHIVE_HPP
...
class forward_structure_iarchive 
...
public:
    ...
    forward_structure_iarchive(implementation_archive_type& ar) 
	  : detail::common_iarchive<Archive>(no_header),
...
#endif // BOOST_ARCHIVE_FORWARD_STRUCTURE_IARCHIVE_HPP
