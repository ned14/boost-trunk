...
void instantiate_ptr_serialization(int) {}
...
namespace boost { namespace archive { namespace detail {                \
                                                                        \
template <class Serializable>                                           \
typename _ptr_serialization_support<Archive, Serializable>::instantiate \
instantiate_ptr_serialization( Archive* );                              \
                                                                        \
}}}
