...
int main()
{
    ...
    typedef mpl::find_if< types, mpl::is_float<_> >::type iter1;
    typedef mpl::find_if< types, mpl::same_as<long> >::type iter2;
    typedef mpl::find_if< types, mpl::same_as<void> >::type iter3;
    ...
    BOOST_STATIC_ASSERT((mpl::distance<first,iter1>::value == 6));
    BOOST_STATIC_ASSERT((mpl::distance<first,iter2>::value == 2));
