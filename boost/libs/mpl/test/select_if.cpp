//-----------------------------------------------------------------------------
// boost mpl/test/select_if.cpp source file
...
int main()
{
    ...
    typedef mpl::select_if_c<true,char,long>::type t2;
    BOOST_MPL_ASSERT_IS_SAME(t1, char);
    BOOST_MPL_ASSERT_IS_SAME(t2, char);

    typedef mpl::select_if<mpl::false_c,char,long>::type t3;
    typedef mpl::select_if_c<false,char,long>::type t4;
